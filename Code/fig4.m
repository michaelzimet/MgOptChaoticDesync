...
lyap_calc(j) = sum(Zp_HH(theta).*uopt*0.01)/(T);
...
figure(4)
subplot(3,2,1)
plot(t, in(9,:), 'b', t, in(7,:), 'r', t, in(5,:), 'g')
...
AddLetters2Plots(figure(4), {'A', 'B','C','D', 'E', 'F'},  'HShift', -0.08, 'VShift', -0.015)

saveas(figure(4), '../Optimal Control Figs/Fig4.eps', 'epsc')